      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16 mt-7">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Apa kata mereka tentang Rindang Coffee - tempat berkumpul di bawah naungan pohon rindang
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index} 
              className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-green-100"
            >
              {/* Profile Section */}
        ...
        <div className="text-center mt-16">
          <div className="inline-block bg-white px-8 py-4 rounded-full shadow-lg">
            <p className="text-gray-700">
              <span className="font-bold text-green-700">500+</span> pelanggan puas dengan layanan kami
            </p>
          </div>
        </div>
      </div>
